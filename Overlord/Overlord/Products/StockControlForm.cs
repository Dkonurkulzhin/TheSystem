    ...
    public partial class StockControlForm : Form
    {
        ...
        private void ChangeStockAmount(int muliplier)
        {
            if (selectedItems != null && numericUpDown1.Value != 0)
                ...
                {
                    ProductManager.EditProductStock(ProductManager.GetSelectedProductByName(item), (int)numericUpDown1.Value * muliplier);
        ...
        private void NotifyAboutEdit(int multiplier)
        {
            ...
            if (selectedItems != null && numericUpDown1.Value != 0)
                foreach (var item in selectedItems)
                {
                    ...
                    messageToSend += ProductManager.GetSelectedProductByName(item).stock;
                    messageToSend += "шт; ";
                }
