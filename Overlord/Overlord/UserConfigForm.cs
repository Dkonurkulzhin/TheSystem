...
namespace Overlord
{
    public partial class UserConfigForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            List<string> users = Program.uscon.ListUsers("");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (listView1.SelectedItems != null)
            {
                ...
                {
                    MessageBox.Show(Program.uscon.DeleteUser(listView1.SelectedItems[0].Text) ? "Пользовтель удален" : "Пользовтель не найден", "Удаление", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void UpdateUserList(string filter)
        {
            listView1.Clear();
            listView1.View = View.List;
            List<string> users = Program.uscon.ListUsers(filter);
            foreach (string user in users)
                listView1.Items.Add(user);
        }
